...
class _FileExpansionTileState extends State<FileExpansionTile> with SingleTickerProviderStateMixin {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          //     child: Row(
          //       children: [
          //         Icon(Icons.file_copy,size: 15,color: Colors.yellow,),
